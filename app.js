...
var APIKeys = {
    appId           : '95cccd3d-a9eb-41ea-9894-50b9ec43f477',
    clientId        : 'mpag6rqv5oawab1zh8hvefta',
    clientSecret    : 'dcmYqXKOwayGiBVzHFasKqyG',
    appSignature    : 'vtfzhfjcsfyhzxmmsjxitjcjd2dpuxxzns1jnlgnyt1zgmed0qaqdisrwdqwwkcz5325n4tg4gq3pswpjhzreevrw2hysrchynd4pfemmfjda1j1w52414jvgj5ugdwqldxygmwykbkt0ferayglbpkp3tgblock0pb4ya54cngzgm5kihxvbqmuvl4p0idpa31pd4oskjdgc400xnbosujvfhwyflpp11nvaleebc5wazmzfivxfra0irp4a1m',
...
app.post('/fireEvent/:type', function( req, res ) {
    var data = req.body;
    var triggerIdFromAppExtensionInAppCenter = 'jb-hello-world-trigger-minsait';
